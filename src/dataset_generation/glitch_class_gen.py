...
from helpers.h5file_helpers import create_dataset, append_gw_sample
from config import *
...
def get_param_values(nsamples):
    levels = np.random.uniform(5e-6, 1e-5, nsamples)
    betas = np.random.uniform(500, 3600, nsamples)
    inj_points = np.random.choice(['tm_12', 'tm_23', 'tm_13',
                                    'tm_21', 'tm_32', 'tm_31'], nsamples)
